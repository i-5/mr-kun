...
public class MrInfoManager {
	...
	try {
	    ...
	    throw new ApplicationError("MRInfoManager.getMrInfo: at SQLException",e);
	}
     ...
     * ここでメソッドの記述を挿入してください。
     * 作成日 : (00/06/22 午後 12:05:10)
     * @return jp.ne.sonet.medipro.mr.MrInfo
     * @param mrID java.lang.String
     */
	...
	try {
	    ...
	    throw new ApplicationError("MrInfoManager.getMrLoginInfo: SQLException",e);
	}
...
//  		pstmt.setString(2, companyCD);
	...
	throw new ApplicationError("MrInfoManager.getMrInfoCheck: SQLException",e);
	}
    ...
    /**
     * @param mrinfo jp.ne.sonet.medipro.mr.MrInfo
     */
	...
	try {
	    ...
	    throw new ApplicationError("MrInfoManager.getMrInfoSub: SQLException",e);
	}
    }
	...
	throw new ApplicationError("MrInfoManager.getMrSpInfo: SQLException",e);
	}
	...
	throw new ApplicationError("MrInfoManager.updateLogin: SQLException",e);
	}
    }
	...
	throw new ApplicationError("MrInfoManager.updateMrProfile: SQLException",e);
	}
    }
	...
	throw new ApplicationError("MrInfoManager.updatePassword: SQLException",e);
	}
    }

    /**
     * @param  mrId java.langString
     * @return boolean
     */
	...
	throw new ApplicationError("MrInfoManager.outOfWorkTime: SQLException",e);
	}
