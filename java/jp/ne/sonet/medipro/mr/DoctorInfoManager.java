...
/* 1027 y-yamada add end */
     ...
     * @return jp.ne.sonet.medipro.mr.DoctorInfo
	...
	try {
	    ...
	    throw new ApplicationError("DoctorInfoManager",e);
	}
     ...
     * @param doctorinfo jp.ne.sonet.medipro.mr.DoctorInfo
     */
	...
	try {
	    ...
	    throw new ApplicationError("DoctorInfoManager",ex);
	}
