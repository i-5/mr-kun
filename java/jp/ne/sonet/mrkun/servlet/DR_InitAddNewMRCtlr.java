 ...
 * @author M.Mizuki
 * @version $Id: DR_InitAddNewMRCtlr.java,v 1.1.2.4 2001/11/13 07:56:55 rick Exp $
 */
public class DR_InitAddNewMRCtlr extends BaseServlet
{
  final String  ERROR_TEMPLATE        = HttpConstant.Dr12_View;
  final String  ADD_NEW_TEMPLATE      = HttpConstant.Dr00_4_View;
  final String  CONFIRM_TEMPLATE      = HttpConstant.Dr00_4_View;
//  final String  EXIT_TEMPLATE         = HttpConstant.Dr02_Ctlr;
  ...
  final String  REQUEST_FINISH_MESSAGE = "FinishMessage";
  ...
  public void doAction(HttpServletRequest request, HttpServletResponse response)
  {
    ...
    try
    {
      ...
      request.setAttribute(REQUEST_FINISH_MESSAGE, "");
      request.setAttribute(REQUEST_MR_CONFIRM, new MR());
      ...
      else if (addAnother == null)
      {
        ...
        if (mr == null)
          throw new ValidationException(SystemMessages.get("dr_initAddNoMatchingMRFound"));//"No MR was found with that Id");
        else if (sessionDR.getMRIdList().contains(mrId))
          throw new ValidationException(SystemMessages.get("dr_initAddAlreadyHaveThisMR"));//"You already have this MR in your list");
        else
        {
      ...
      else
      {
        ...
        request.setAttribute(REQUEST_FINISH_MESSAGE, "Finish");
