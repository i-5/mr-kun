set ORACLE_HOME=I:\Oracle\Ora81
set NLS_LANG=Japanese_Japan.JA16SJIS
set TNS_ADMIN=I:\Oracle\Ora81\network\admin

@echo off
@rem $Id: v2_startWebLogic.cmd,v 1.1.2.3 2001/09/18 02:25:24 rick Exp $
...
:runWebLogicJava
set WEBLOGIC_CLASSPATH=.\license;.\lib\weblogic510sp9.jar;.\classes;.\lib\weblogicaux.jar;.\v2server\serverclasses;.\v2server\ejbclasses;.\v2server\servletclasses;.\lib\jdom.jar;.\lib\xerces.jar;.\v2server\lib\jspSmartUpload.jar;.\v2server\lib\jgl3.1.0.jar
...
%JAVA_HOME%\bin\java -ms64m -mx64m -classpath %JAVA_CLASSPATH% -Dweblogic.class.path=%WEBLOGIC_CLASSPATH% -Dweblogic.home=. -Djava.security.manager -Djava.security.policy==.\weblogic.policy -Dweblogic.system.name=v2server weblogic.Server
goto finish
...
set CLASSPATH=%CLASSPATH%;.\license;.\lib\weblogic510sp9boot.jar;.\classes\boot;.\lib\weblogic510sp9.jar;.\classes;.\lib\weblogicaux.jar;.\v2server\serverclasses;.\eval\cloudscape\lib\cloudscape.jar;.\lib\rmiForMs.zip
