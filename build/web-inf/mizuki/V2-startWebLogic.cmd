@echo off
@rem $Id: V2-startWebLogic.cmd,v 1.1.2.4 2001/10/04 07:01:01 mizuki Exp $
...
set PRE_CLASSPATH=.\V2server\lib\jdom.jar;.\V2server\lib\xerces.jar;.\V2server\lib\jspSmartUpload.jar;.\V2server\lib\jgl3.1.0.jar
set POST_CLASSPATH=
...
set JAVA_CLASSPATH=.\lib\weblogic510sp6boot.jar;.\classes\boot;.\eval\cloudscape\lib\cloudscape.jar;
goto runWebLogicJava

:setJava117
set JAVA_CLASSPATH=%JAVA_HOME%\lib\classes.zip;.\lib\weblogic510sp6boot.jar;.\classes\boot;.\eval\cloudscape\lib\cloudscape.jar;.\lib\jspSmartUpload.jar
goto runWebLogicJava

:runWebLogicJava
set WEBLOGIC_CLASSPATH=.\license;.\lib\weblogic510sp6.jar;.\classes;.\lib\weblogicaux.jar;.\V2server\serverclasses
...
%JAVA_HOME%\bin\java -ms64m -mx64m -classpath %JAVA_CLASSPATH% -Dweblogic.class.path=%WEBLOGIC_CLASSPATH% -Dweblogic.home= -Dweblogic.system.name=V2server -Dmrkun.dridname=mizukiDrId -Dmrkun.hash=false -Djava.security.manager -Djava.security.policy==.\weblogic.policy weblogic.Server
goto finish
...
set CLASSPATH=%CLASSPATH%;.\license;.\lib\weblogic510sp6boot.jar;.\classes\boot;.\lib\weblogic510sp6.jar;.\classes;.\lib\weblogicaux.jar;.\myserver\serverclasses;.\eval\cloudscape\lib\cloudscape.jar;.\lib\rmiForMs.zip
