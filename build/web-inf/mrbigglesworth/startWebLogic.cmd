@echo off
@rem $Id: startWebLogic.cmd,v 1.1.2.3 2001/09/10 09:43:29 rick Exp $
...
:dynClasspath
set _LIBJARS=
for %%i in (myserver\lib\*.jar) do call cpappend.bat %%i

rem set POST_CLASSPATH=.\myserver\lib\xerces.jar;.\myserver\lib\jdom.jar;.\myserver\lib\jspSmartUpload.jar
set POST_CLASSPATH=%_LIBJARS%;%POST_CLASSPATH%
