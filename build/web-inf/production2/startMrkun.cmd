...
set TNS_ADMIN=c:\Oracle\Ora81\network\admin

@echo off
@rem $Id: startMrkun.cmd,v 1.1.2.1 2001/09/18 01:02:00 behrens Exp $
...
:runWebLogicJava
set WEBLOGIC_CLASSPATH=.\license;.\lib\weblogic510sp9.jar;.\classes;.\lib\weblogicaux.jar;.\myserver\serverclasses;.\myserver\ejbclasses;.\myserver\servletclasses;.\myserver\lib\jdom.jar;.\myserver\lib\xerces.jar;.\lib\activation.jar;.\myserver\lib\jgl3.1.0.jar;.\myserver\lib\jspSmartUpload.jar
...
%JAVA_HOME%\bin\java -ms64m -mx64m -classpath %JAVA_CLASSPATH% -Dweblogic.class.path=%WEBLOGIC_CLASSPATH% -Dweblogic.home=. -Djava.security.manager -Djava.security.policy==.\weblogic.policy -Dweblogic.system.name=myserver weblogic.Server
goto finish
